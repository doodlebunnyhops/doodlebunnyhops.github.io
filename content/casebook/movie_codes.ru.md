...
![Bloomindaisy смотрит фильм «Первый контакт»](/images/bh/watching_movie.webp)
...
![Панель переключателей Агентства](/images/bh/agency_switch_board_200.webp)
{{% notice style="red" %}}
...
![Вход на чердак через вентиляцию в тюремной камере.](/images/bh/blue-key-card-wall.webp)
{{% /tab %}}
...
![Старая лестница в Полицейском участке, ведущая к киноплёнке.](/images/bh/movie_police.webp)
{{% /tab %}}

{{% tab title="Старое расположение киноплёнки" %}}
![Старое местоположение киноплёнки в Полицейском участке.](/images/bh/movie_poice_code.webp)
{{% /tab %}}
{{< /tabs >}}
...
{{< column "grid-2" >}}
![Расположение киноплёнки в Заброшенном доме](/images/bh/movie_abanoned_house_code.webp)
{{< /column >}}
...
![Расположение Арки Eagle View](/images/bh/movie_arch_location.webp)
{{% /tab %}}

{{% tab title="Киноплёнка внутри ямы" %}}
![Код фильма на киноплёнке под Аркой Eagle View](/images/bh/movie_arch_code.webp)
{{% /tab %}}
...
![Расположение киноплёнки в кинотеатре](/images/bh/movie_code.webp)
...
![Ввод кода фильма в кинопроектор](/images/bh/input_movie_code.webp)
{{% /tab %}}

{{% tab title="Смотрите фильм..." %}}
![Новый фильм играет в кинотеатре](/images/bh/movie_theater.webp)
{{% /tab %}}
...
![Панель сообщений бункера Агентства](/images/bh/bunker_message_panel.webp)
