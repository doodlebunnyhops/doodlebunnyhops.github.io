...
**Побочный квест** : [Электрическое здание](/lore/quests/electric_building)
...
2. Разместите спальный мешок снаружи левой стены рядом с **аркадой**  
3. В **банке** положите спальный мешок у левой стены  
4. В **крыше церкви** (заберитесь на крышу и положите спальный мешок)  
5. **Рядом с Продуктовым магазином** положите спальный мешок у травяной стены  
6. В **коридоре кинотеатра** используйте спальный мешок в нижней правой части двери и баннера фильма  

{{% notice style="info" title="Меняет местоположение во время особых событий" expanded=false %}}

Углеродный блок, который раньше находился в торговом центре, перемещается в Бункер Агентства во время событий, когда торговый центр убран.

![Углеродный блок, парящий перед логотипом Агентства в Бункере](/images/bh/carbon_block_agency_base.webp?width=400px)
...
![Углеродный блок, спрятанный за стеной в логове преступников](/images/bh/carbon_block_criminal_base.webp)
{{% /tab %}}

{{% tab title="Локация #2" %}}
Местоположение углеродного блока было перемещено к левой стене аркады. Проще всего использовать спальный мешок снаружи.

{{< column "grid-2" >}}
![Углеродный блок, спрятанный в стене аркады между Big Frank's Motors и Аркадой.](/images/bh/carbon_block_arcade_street_view.webp)
![Углеродный блок, спрятанный внутри стены аркады.](/images/bh/carbon_block_arcade_sleeping_bag_view.webp)
...
![Кристалл в черноте](/images/bh/carbon_block_church_roof.webp)
{{% /tab %}}

{{% tab title="Локация #5" %}}
Рядом с Продуктовым магазином положите спальный мешок у травяной стены.

![Кристалл в черноте](/images/bh/carbon_block_green_wall.webp)
{{% /tab %}}
...
![Сообщение об ошибке низкого напряжения](/images/bh/carbon_block_low_voltage.webp)
{{% /notice %}}  
