...
{{% notice style="info" title="Бункер Агентства" %}}
В настоящее время за бункером Агентства была добавлена коричневая грязевая стена, закрывающая обзор на этот монолит.
{{% /notice %}}