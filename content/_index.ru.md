...
В кемпинге появилось новое дерево… и, конечно же, это не просто обычное дерево.

Несколько странных деталей вокруг него раскрывают код… и у этого кода есть применение.

##### [Загляни в квест с кодом из кемпинга](/lore/quests/a28_boot_sequence/)

Ещё пара важных моментов:
- [Торговый центр](/map/poi/mall) временно убрали ради Летнего карнавала → [углеродный блок](/lore/quests/destroy_carbon_blocks) переместили в [Бункер Агентства](/map/poi/agency-bunker/)
- Коды из фильмов тоже пока нельзя посмотреть
