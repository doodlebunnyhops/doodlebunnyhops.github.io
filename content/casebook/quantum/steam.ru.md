...
![Монолит исчезает, медленно растворяясь.](/images/bh/monolith-despawning.webp)
{{% /tab %}}

{{% tab title="Пар" %}}
Почему Монолиты вызывают пар в этой комнате? Возможно, энергия накапливается для создания нового Монолита?

![Пар в Квантовой комнате после исчезновения монолита.](/images/bh/steam-in-quantum-room.webp)
{{% /tab %}}

{{% tab title="Пол вспыхивает" %}}
Когда появляется новый Монолит, пол в том месте, где был пар, вспыхивает чёрным.

![Пол Квантовой комнаты вспыхивает чёрным, когда появился новый Монолит.](/images/bh/quantum-room-floor-flash-black.webp)
{{% /tab %}}
