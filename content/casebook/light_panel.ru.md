...
1. Выполните шаги, указанные в разделе [на базе Агентства](/lore/quests/build_portal/#at-the-agency-base) в квесте **«Построить портал»**.
...
4. Вернитесь на [экспериментальную базу Агентства]() – теперь можно **ударить электричеством пришельца в капсуле**.
...
- [Сообщение на ноутбуке](/casebook/computer/agency/#power-of-the-book)
