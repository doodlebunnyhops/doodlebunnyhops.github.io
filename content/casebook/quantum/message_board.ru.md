...
2. Отправляйтесь в **Ратушу**.  
   - Включите переключатель **"Danger"**: активирует [A01](/casebook/light_panel#a01).  
   - Убедитесь, что **High Voltage отключён**.  
   - Включите **водяные клапаны №2, №3 и №4** (считая слева направо от 1 до 5): активирует [V08](/casebook/light_panel#v08).  
