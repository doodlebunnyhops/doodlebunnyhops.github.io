...
{{% notice icon="fa-solid fa-triangle-exclamation" style="tip" title="У A28 есть второе сообщение" expanded=false %}}
Примерно через 5 игровых часов сообщение A28 изменится на `Awaiting boot code`
{{% /notice %}}
...
**Могилы у Бункера Агентства запечатаны**

>**Требования**: [Квест в Подземелье Агентства завершён](lore/quests/agency_coffin_portal)

**Шаги:**

1. После завершения последнего этапа [квеста в Подземелье Агентства](lore/quests/agency_coffin_portal/portal/), который запускает кат-сцену, H05 включится.
